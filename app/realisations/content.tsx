...
const projects = [
  ...
  {
    name: "Setting",
    what: "Prospection LinkedIn externalisée avec IA signal-based + setter dédié",
    how: "Landing page conversion, simulateur ROI, guides, ressources SEO",
    tags: ["Next.js", "Tailwind", "SaaS", "SEO"],
    url: null,
    category: "site" as const,
